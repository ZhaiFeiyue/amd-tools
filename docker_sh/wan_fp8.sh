...
sudo docker run --name zhai_wan_fp8 -it --shm-size=128G --ulimit memlock=-1 --ulimit stack=67108864 --network=host  --group-add=video \
	        --ipc=host --cap-add=SYS_PTRACE --security-opt seccomp=unconfined \
		        --device /dev/kfd  --device /dev/dri \
			        -v /raid/models/HF:/hf  -v /home/feiyzhai/code:/workspace/code \
				 rocm/ali-private:diffsynth-yunchang-1117
