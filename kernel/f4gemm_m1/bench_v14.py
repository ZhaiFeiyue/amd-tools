#!/usr/bin/env python3
"""Benchmark v14 with FULLY preshuffled inputs (same format as CK/ASM)."""
...
# Compile
src = f"{KDIR}/f4gemm_m1_v14.cpp"
SO = f"{KDIR}/f4gemm_m1_v14.so"
...
# Shuffled path (for v14 and CK/ASM)
...
print(f"  v14[:8]:    {D_hip[0,:8].float().cpu().tolist()}")
...
ms_v14 = triton.testing.do_bench(run_v14, warmup=15, rep=80)
tflops_v14 = 2.0 * M * N * K / ms_v14 * 1e-9
print(f"\nv14 preshuffled: {ms_v14:.4f} ms, {tflops_v14:.2f} TFLOPS")
...
print(f"\n{'='*50}")
print(f"v14 vs CK:  {tflops_v14/tflops_ck:.3f}x")
print(f"v14 vs ASM: {tflops_v14/tflops_asm:.3f}x")
